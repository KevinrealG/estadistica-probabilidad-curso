...
| **43-50s** | **(Cierre)** Todo nace de una simple tabla. ¿Qué otra variable te gustaría analizar? ¡Déjala en los comentarios! | **Cámara:** Vuelves tú a la pantalla (o tu avatar). **Texto en pantalla:** "¿Qué variable analizamos ahora?". | *Whoosh* de salida y corte musical. |
